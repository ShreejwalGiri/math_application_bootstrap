<form method="post" action="modular/condition.php?page=matrix_transpose">
	<div class="container" style="margin-bottom: 9% ">
		<div class="row" >
			<div class="col-md-3">
				<label class="sub-label">To calculate the Transpose of the given matrix   </label>
				<div>
					<label>1. Calculation Transpose Matrix for 2 X 2 Matrix ?</label>
					...
					<label style="margin-top: 50px;" > 2. Calculation Transpose Matrix for 3 X 3 Matrix ?</label>
					<div class="row" style="margin-left:5%;">
						<div>
